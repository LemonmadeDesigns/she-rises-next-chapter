          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div className="group relative overflow-hidden rounded-2xl">
              ...
              <div className="relative p-12">
                ...
                <h3 className="font-serif text-3xl font-bold text-[#3D2645] dark:text-white mb-6">Our Vision</h3>
                <p className="text-lg text-[#3D2645] dark:text-white/90 leading-relaxed">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="font-serif text-5xl md:text-6xl font-bold text-[#3D2645] dark:text-[#F2F2F2] mb-6">
                Our Values
              </h2>
              <p className="text-xl text-[#4A4A4A] dark:text-[#B3B3B3] max-w-3xl mx-auto">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div className="bg-gradient-to-br from-soft-gray to-white dark:bg-card border-2 border-gray-300 dark:border-border rounded-2xl p-10 shadow-xl">
                <h4 className="font-serif text-2xl font-bold text-[#3D2645] dark:text-[#F2F2F2] mb-8">We Provide:</h4>
              ...
              <div className="p-12 md:p-16">
                <div className="grid md:grid-cols-3 gap-12 items-center">
                  <div className="md:col-span-2 space-y-6">
                    <h3 className="font-serif text-3xl md:text-4xl font-bold text-[#3D2645] dark:text-[#F2F2F2]">
                      Precious Ransom
                    </h3>
                    <div className="text-lg text-rose-gold font-semibold">Executive Director</div>
                    <p className="text-lg text-[#4A4A4A] dark:text-[#B3B3B3] leading-relaxed">
                    ...
                    <div className="bg-soft-gray dark:bg-muted border-l-4 border-rose-gold pl-6 py-4 italic">
                      <p className="text-xl text-[#3D2645] dark:text-[#F2F2F2] leading-relaxed">
                  ...
                  <div className="text-center">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-center gap-2 text-[#4A4A4A] dark:text-[#B3B3B3] hover:text-rose-gold transition-colors">
