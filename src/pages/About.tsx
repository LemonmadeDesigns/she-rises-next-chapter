                ...
                <ul className="space-y-4">
                  {whatWeDo.map((item, index) => (
                    <li key={index} className="flex items-start group">
                      ...
                      <span className="text-foreground/80 dark:text-muted-foreground leading-relaxed">{item}</span>
                    </li>
                  ))}
                </ul>
              </div>
              ...
              <div className="p-12 md:p-16">
                <div className="grid md:grid-cols-3 gap-12 items-center">
                  <div className="md:col-span-2 space-y-6">
                    ...
                    <p className="text-lg text-foreground/80 dark:text-muted-foreground leading-relaxed">
                    ...
                    <div className="bg-soft-gray dark:bg-muted border-l-4 border-rose-gold pl-6 py-4 italic">
                      <p className="text-xl text-deep-plum dark:text-foreground leading-relaxed">
